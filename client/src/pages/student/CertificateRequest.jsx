...
export default function CertificateRequest() {
  ...
  async function onSubmit(e) {
    ...
    try {
      await api.post(`/certificates/${id}/request`, fd, {
      ...
      <form onSubmit={onSubmit} className="bg-white shadow rounded-lg p-6 space-y-4">
        <div>
          ...
          <input
            ...
            onChange={(e) => set('applicantFullName', e.target.value.toUpperCase())}
          />
        </div>
        ...
        <div className="grid sm:grid-cols-2 gap-4">
          <div>
            ...
            <input
              ...
              onChange={(e) => set('durationFrom', e.target.value)}
            />
          </div>
          <div>
        ...
        <div>
          ...
          <input
            ...
            placeholder="Name of your allotted supervisor"
          />
        </div>
        <div>
